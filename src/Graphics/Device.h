...
class Device {
   ...
   public:
     ...
     *
     * @param D3DDevice The D3D12 device to create the allocator with.
     ...
     * synchronization.
     *
     * @param D3DDevice The D3D12 device to create the queue with.
     ...
     *
     * @param D3DDevice The D3D12 device to create the heap with.
     ...
     * the RTV heap.
     *
     * @param Resource The D3D12 resource to create the RTV for.
     ...
     * DeviceBuffer).
     * @param BufferName The debug name for the buffer resource.
     * @param Type The heap type for the buffer (e.g., D3D12_HEAP_TYPE_UPLOAD,
     * D3D12_HEAP_TYPE_DEFAULT).
     * @param State The initial resource state for the buffer (e.g., D3D12_RESOURCE_STATE_COMMON,
        ...
        requires std::is_base_of_v<DeviceBuffer, T>
    {
        ...
        OutBuffer = std::make_unique<T>(Type, State, BufferSize, d3dBuffer);
        return true;
    }
     ...
     * window.
     *
     * @param HWnd The window handle to disable the fullscreen toggle for.
     */
